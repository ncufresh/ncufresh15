...
<div class="row">
    <div id="category-menu" class="col s12 l3">
        <div class="collection">
            <a href="{{ url('/qa')}}" class="collection-item">
                全部<span class="badge">{{$all_count}}</span>
            </a>
            <a href="{{ url('/qa/category/life')}}" class="collection-item">
                中大生活<span class="badge">{{$counts[0]}}</span>
            </a>
            <a href="{{ url('/qa/category/gov')}}" class="collection-item">
                行政<span class="badge">{{$counts[1]}}</span>
            </a>
            <a href="{{ url('/qa/category/student')}}" class="collection-item">
                學務<span class="badge">{{$counts[2]}}</span>
            </a>
            <a href="{{ url('/qa/category/game')}}" class="collection-item">
